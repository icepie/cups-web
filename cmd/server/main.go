...
func main() {
	...
	protected.HandleFunc("/scan-projects", scanProjectsHandler).Methods("GET")
	protected.HandleFunc("/scan-projects", createScanProjectHandler).Methods("POST")
	protected.HandleFunc("/scan-projects/{projectId:[0-9]+}", scanProjectHandler).Methods("GET")
	protected.HandleFunc("/scan-projects/{projectId:[0-9]+}", deleteScanProjectHandler).Methods("DELETE")
	protected.HandleFunc("/scan-projects/{projectId:[0-9]+}/pages", createScanPageHandler).Methods("POST")
	protected.HandleFunc("/scan-projects/{projectId:[0-9]+}/pages/order", reorderScanPagesHandler).Methods("PUT")
	protected.HandleFunc("/scan-projects/{projectId:[0-9]+}/pages/{pageId:[0-9]+}", updateScanPageHandler).Methods("PUT")
